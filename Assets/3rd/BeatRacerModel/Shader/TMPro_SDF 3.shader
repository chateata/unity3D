...
Properties {
 ...
 _ClipRect ("Clip Rect", Vector) = (-100000.000000,-100000.000000,100000.000000,100000.000000)
...
void main ()
{
  ...
  xlv_TEXCOORD4 = (tmpvar_20 * (_WorldSpaceCameraPos - (unity_ObjectToWorld * vert_8).xyz));
}
