...
void main ()
{
  ...
  tmpvar_6 = clamp (((tmpvar_5.w * xlv_TEXCOORD1.x) - xlv_TEXCOORD1.w), 0.0, 1.0);
  lowp vec4 tmpvar_7;
  tmpvar_7 = (xlv_COLOR * tmpvar_6);
  c_4 = tmpvar_7;
  ...
  tmpvar_13 = (tmpvar_12 * xlv_TEXCOORD2.zw);
  s_3 = tmpvar_13;
  highp vec2 tmpvar_14;
  tmpvar_14 = clamp (((
    ((abs((xlv_TEXCOORD2.xy - _MaskCoord.xy)) - _MaskCoord.zw) * xlv_TEXCOORD2.zw)
   + s_3) / (1.0 + s_3)), 0.0, 1.0);
  mediump vec2 tmpvar_15;
  tmpvar_15 = (1.0 - tmpvar_14);
  m_2 = (tmpvar_15 * tmpvar_15);
  c_4 = (c_4 * (m_2.x * m_2.y));
  tmpvar_1 = c_4;
  gl_FragData[0] = tmpvar_1;
}
